...
.PHONY: all compile debug size run test test-one clean summary
...
size: CFLAGS = -Os -s -Wall -Wextra -fomit-frame-pointer -fmerge-all-constants -fno-unwind-tables -fno-asynchronous-unwind-tables
